...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        GPSdata.Lattitude = (float(
            data2[6])+(0.5*cos(pi/180*float(data2[3]))-0.1*sin(pi/180*float(data2[3])))/6356752*180/pi)
        GPSdata.Longitude = (float(data2[7])+(0.5*sin(pi/180*float(data2[3]))+0.1*cos(
            pi/180*float(data2[3])))/6365986/cos(pi/180*GPSdata.Lattitude)*180/pi)
